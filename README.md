...
claude \
  ...
  --dangerously-load-development-channels plugin:claude-html-channels:html-channel
```

No need to run `claude mcp add` — the plugin includes the MCP server definition.
